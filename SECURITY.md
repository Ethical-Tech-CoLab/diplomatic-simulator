...
An interactive multi-party diplomatic negotiation simulation, plus the research report and a mixed-model comparative audit. Runs entirely in the browser.
